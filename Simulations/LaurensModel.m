...
% For dual line
params.tn1 = 25; %75.9; %75;
params.tn2 = 10000;
params.sigprior = eye(3)*0.005;
...
%[tinteg, full_states] = ode45(@(t,y) LaurensVestibularModelDeriv(t,y,u,params), [min(t), max(t)], init_x);
...
for i=1:length(tinteg)
    ...
    [D(:,i), AW(:,i)] = CanalParticleWeighting( Dinput, params.sigprior );
